    ...
    WebsiteMessage: {
      init: function () {
        $.ajax({
          ...
          success: function (data) {
            if (data) {
              ...
              var _msgHtml = []
              _msgHtml.push(
                                '<a href="http://www.yougou.com/my/msg.jhtml?' +
              ...
              if (count != 0) {
                try {
                  ...
                  $('#css_no_num').attr(
                                        'href',
                                        'http://www.yougou.com/my/msg.jhtml?' +
                                            YouGou.Util.timestamp()
                                    )
        ...
        $.get('/my/getCommentCount.jhtml', function (d) {
          var msg =
                        '<a href="http://www.yougou.com/my/comment.jhtml?' +
                        YouGou.Util.timestamp() +
                        '">等待点评(<i class="corg">' +
                        d +
                        '</i>)</a>'
...
function login () {
  location.href =
        'http://www.yougou.com/signin.jhtml?redirectURL=' +
...
function register () {
  location.href =
        'http://www.yougou.com/register.jhtml?redirectURL=' +
        encodeURI(location.href)
  return false
}
